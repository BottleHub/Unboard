...
type ComplexityRoot struct {
	...
	Query struct {
		...
		Timelines func(childComplexity int, input model.Fetch) int
	}
...
type QueryResolver interface {
	Timelines(ctx context.Context, input model.Fetch) ([]*model.Timeline, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.timelines":
		...
		return e.complexity.Query.Timelines(childComplexity, args["input"].(model.Fetch)), true
...
func (ec *executionContext) field_Query_timelines_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.Fetch
	if tmp, ok := rawArgs["input"]; ok {
...
func (ec *executionContext) _Query_timelines(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Timelines(rctx, fc.Args["input"].(model.Fetch))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
